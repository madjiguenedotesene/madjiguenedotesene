# 👋 Bonjour ! Je suis Madjiguene Sène
...
| :----------------------------------------- | :------------------------------------------ | :----------------------------------------- |
| **Python** (Pandas, NumPy, Matplotlib)     | **Conteneurisation** (Docker, Docker-Compose) | **Sécurité Applicative** (OWASP Top 10)     |
| **Machine Learning** (Scikit-learn)        | **Orchestration** (Kubernetes, K8s)         | **Analyse SAST/DAST** (SonarQube, Snyk)     |
| **Deep Learning** (TensorFlow, PyTorch)    | **CI/CD** (GitHub Actions, GitLab CI)       | **Pentest Web** (Burp Suite, OWASP Zap)     |
| **Big Data** (Apache Spark, PySpark)       | **Cloud IaaS** (AWS [EC2, S3], Azure, GCP)  | **Analyse Réseau** (Wireshark, Nmap, Scapy) |
| **MLOps** (MLflow, DVC, Kubeflow)          | **API Backend** (FastAPI, Flask, Node.js)   | **SIEM & Logs** (Splunk, ELK Stack)         |
| **Cloud Data** (AWS SageMaker, Vertex AI)  | **Frontend** (React, Angular)               | **Gestion des Secrets** (HashiCorp Vault)   |
| **Base de Données** (PostgreSQL, MongoDB) | **Gestion de version** (Git, Git-Flow)      | **Cloud Security** (IAM, Groupes Sécurité)  |
...
1.  **🌟 Projet "Licorne" : Honeypot Web avec Détection d'Attaques par IA**
    ...
    * *Tech :* Python, FastAPI, PostgreSQL, Scikit-learn, Docker, AWS EC2.
    * *Statut :* Déployé sur AWS !
    

2.  **🔍 Analyse de Logs de Sécurité (SIEM) avec Spark**
    * *Description :* Simulation d'un pipeline SIEM (ELK Stack) et analyse distribuée de logs système (10Go) avec PySpark pour détecter des patterns d'attaque et des anomalies.
    * *Tech :* ELK Stack, Apache Spark (PySpark), Python, Docker.
    

3.  **🚀 Déploiement Scalable d'Application Web (Microservices)**
    * *Description :* Architecture microservices d'une application MERN (MongoDB, Express, React, Node.js), orchestrée avec Kubernetes (K8s) et déployée via un pipeline CI/CD GitHub Actions sur Google Cloud (GKE).
    * *Tech :* React, Node.js, MongoDB, Docker, Kubernetes, GitHub Actions, GCP.
